...
class Program
{
    ...
    static void Main()
    {
        ...
        bus.composterList.Add(new Composter());
        bus.composterList[0].tickets.Add(new Ticket(1));
        bus.composterList[0].tickets.Add(new Ticket(2));

        bus.composterList[1].tickets.Add(new Ticket(1));
        bus.composterList[1].tickets.Add(new Ticket(2));
        bus.composterList[1].tickets.Add(new Ticket(1));
